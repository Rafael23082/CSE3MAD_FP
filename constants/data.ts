...
export const ACTION_CONFIGS: Record<string, ActionConfig[]> = {
  "parachute-drop-challenge": [
    {
      id: "action-1",
      labelKey: "activities.parachuteDropChallenge.action1.label",
      subtitleKey: "activities.parachuteDropChallenge.action1.subtitle",
      inputs: [
        { id: "timeToGround", labelKey: "activities.parachuteDropChallenge.inputs.timeToGround", type: "number", placeholderKey: "activities.parachuteDropChallenge.inputs.zero" },
        { id: "landingAccuracy", labelKey: "activities.parachuteDropChallenge.inputs.landingAccuracy", type: "number", placeholderKey: "activities.parachuteDropChallenge.inputs.zero" },
        { id: "observation", labelKey: "activities.parachuteDropChallenge.inputs.observationNotes", type: "text", placeholderKey: "activities.parachuteDropChallenge.inputs.describeWhatHappened" },
      ],
    },
    {
      id: "action-2",
      labelKey: "activities.parachuteDropChallenge.action2.label",
      subtitleKey: "activities.parachuteDropChallenge.action2.subtitle",
      inputs: [
        { id: "timeToGround", labelKey: "activities.parachuteDropChallenge.inputs.timeToGround", type: "number", placeholderKey: "activities.parachuteDropChallenge.inputs.zero" },
        { id: "landingAccuracy", labelKey: "activities.parachuteDropChallenge.inputs.landingAccuracy", type: "number", placeholderKey: "activities.parachuteDropChallenge.inputs.zero" },
        { id: "observation", labelKey: "activities.parachuteDropChallenge.inputs.observationNotes", type: "text", placeholderKey: "activities.parachuteDropChallenge.inputs.describeWhatHappened" },
    ...
    {
      id: "action-3",
      labelKey: "activities.parachuteDropChallenge.action3.label",
      subtitleKey: "activities.parachuteDropChallenge.action3.subtitle",
      inputs: [
        { id: "timeToGround", labelKey: "activities.parachuteDropChallenge.inputs.timeToGround", type: "number", placeholderKey: "activities.parachuteDropChallenge.inputs.zero" },
        { id: "landingAccuracy", labelKey: "activities.parachuteDropChallenge.inputs.landingAccuracy", type: "number", placeholderKey: "activities.parachuteDropChallenge.inputs.zero" },
        { id: "observation", labelKey: "activities.parachuteDropChallenge.inputs.observationNotes", type: "text", placeholderKey: "activities.parachuteDropChallenge.inputs.describeWhatHappened" },
  ...
  "sound-pollution-hunter": [
    {
      id: "action-1",
      labelKey: "activities.soundPollutionHunter.action1.label",
      subtitleKey: "activities.soundPollutionHunter.action1.subtitle",
      inputs: [
        { id: "measuredDb", labelKey: "activities.soundPollutionHunter.inputs.measuredDb", type: "number", placeholderKey: "activities.soundPollutionHunter.inputs.useSoundMeter" },
        { id: "observation", labelKey: "activities.soundPollutionHunter.inputs.observationNotes", type: "text", placeholderKey: "activities.soundPollutionHunter.inputs.describeWhatHappened" },
      ],
    },
    {
      id: "action-2",
      labelKey: "activities.soundPollutionHunter.action2.label",
      subtitleKey: "activities.soundPollutionHunter.action2.subtitle",
      inputs: [
        { id: "measuredDb", labelKey: "activities.soundPollutionHunter.inputs.measuredDb", type: "number", placeholderKey: "activities.soundPollutionHunter.inputs.useSoundMeter" },
        { id: "observation", labelKey: "activities.soundPollutionHunter.inputs.observationNotes", type: "text", placeholderKey: "activities.soundPollutionHunter.inputs.describeWhatHappened" },
      ],
    ...
    {
      id: "action-3",
      labelKey: "activities.soundPollutionHunter.action3.label",
      subtitleKey: "activities.soundPollutionHunter.action3.subtitle",
      inputs: [
        { id: "measuredDb", labelKey: "activities.soundPollutionHunter.inputs.measuredDb", type: "number", placeholderKey: "activities.soundPollutionHunter.inputs.useSoundMeter" },
        { id: "observation", labelKey: "activities.soundPollutionHunter.inputs.observationNotes", type: "text", placeholderKey: "activities.soundPollutionHunter.inputs.describeWhatHappened" },
      ],
  ...
  "hand-fan-challenge": [
    {
      id: "action-1",
      labelKey: "activities.handFanChallenge.action1.label",
      subtitleKey: "activities.handFanChallenge.action1.subtitle",
      inputs: [
        { id: "foldsCount", labelKey: "activities.handFanChallenge.inputs.numberOfFolds", type: "number", placeholderKey: "activities.handFanChallenge.inputs.zero" },
        { id: "materialUsed", labelKey: "activities.handFanChallenge.inputs.materialUsed", type: "text", placeholderKey: "activities.handFanChallenge.inputs.paperOrCardboard" },
        { id: "observedAngle", labelKey: "activities.handFanChallenge.inputs.observedBendAngle", type: "number", placeholderKey: "activities.handFanChallenge.inputs.zero" },
        { id: "observation", labelKey: "activities.handFanChallenge.inputs.observationNotes", type: "text", placeholderKey: "activities.handFanChallenge.inputs.describeWhatHappened" },
      ],
    },
    {
      id: "action-2",
      labelKey: "activities.handFanChallenge.action2.label",
      subtitleKey: "activities.handFanChallenge.action2.subtitle",
      inputs: [
        { id: "foldsCount", labelKey: "activities.handFanChallenge.inputs.numberOfFolds", type: "number", placeholderKey: "activities.handFanChallenge.inputs.zero" },
        { id: "materialUsed", labelKey: "activities.handFanChallenge.inputs.materialUsed", type: "text", placeholderKey: "activities.handFanChallenge.inputs.paperOrCardboard" },
        { id: "observedAngle", labelKey: "activities.handFanChallenge.inputs.observedBendAngle", type: "number", placeholderKey: "activities.handFanChallenge.inputs.zero" },
    ...
    {
      id: "action-3",
      labelKey: "activities.handFaNChallenge.action3.label",
      subtitleKey: "activities.handFaNChallenge.action3.subtitle",
      inputs: [
        { id: "foldsCount", labelKey: "activities.handFanChallenge.inputs.numberOfFolds", type: "number", placeholderKey: "activities.handFanChallenge.inputs.zero" },
        { id: "materialUsed", labelKey: "activities.handFanChallenge.inputs.materialUsed", type: "text", placeholderKey: "activities.handFanChallenge.inputs.paperOrCardboard" },
        { id: "observedAngle", labelKey: "activities.handFanChallenge.inputs.observedBendAngle", type: "number", placeholderKey: "activities.handFanChallenge.inputs.zero" },
  ...
  "earthquake-resistant-structure": [
    {
      id: "action-1",
      labelKey: "activities.earthquakeResistantStructure.action1.label",
      subtitleKey: "activities.earthquakeResistantStructure.action1.subtitle",
      inputs: [
        { id: "designDescription", labelKey: "activities.earthquakeResistantStructure.inputs.designDescription", type: "text", placeholderKey: "activities.earthquakeResistantStructure.inputs.designDescriptionPlaceholder" },
        { id: "predictedMovement", labelKey: "activities.earthquakeResistantStructure.inputs.predictedMovement", type: "number", placeholderKey: "activities.earthquakeResistantStructure.inputs.zero" },
        { id: "measuredMovement", labelKey: "activities.earthquakeResistantStructure.inputs.measuredMovement", type: "number", placeholderKey: "activities.earthquakeResistantStructure.inputs.useVibrationTest" },
        { id: "observation", labelKey: "activities.earthquakeResistantStructure.inputs.observationNotes", type: "text", placeholderKey: "activities.earthquakeResistantStructure.inputs.describeWhatHappened" },
      ],
    },
    {
      id: "action-2",
      labelKey: "activities.earthquakeResistantStructure.action2.label",
      subtitleKey: "activities.earthquakeResistantStructure.action2.subtitle",
      inputs: [
        { id: "designDescription", labelKey: "activities.earthquakeResistantStructure.inputs.designDescription", type: "text", placeholderKey: "activities.earthquakeResistantStructure.inputs.designDescriptionPlaceholder" },
        { id: "predictedMovement", labelKey: "activities.earthquakeResistantStructure.inputs.predictedMovement", type: "number", placeholderKey: "activities.earthquakeResistantStructure.inputs.zero" },
        { id: "measuredMovement", labelKey: "activities.earthquakeResistantStructure.inputs.measuredMovement", type: "number", placeholderKey: "activities.earthquakeResistantStructure.inputs.useVibrationTest" },
    ...
    {
      id: "action-3",
      labelKey: "activities.earthquakeResistantStructure.action3.label",
      subtitleKey: "activities.earthquakeResistantStructure.action3.subtitle",
      inputs: [
        { id: "designDescription", labelKey: "activities.earthquakeResistantStructure.inputs.designDescription", type: "text", placeholderKey: "activities.earthquakeResistantStructure.inputs.designDescriptionPlaceholder" },
        { id: "predictedMovement", labelKey: "activities.earthquakeResistantStructure.inputs.predictedMovement", type: "number", placeholderKey: "activities.earthquakeResistantStructure.inputs.zero" },
        { id: "measuredMovement", labelKey: "activities.earthquakeResistantStructure.inputs.measuredMovement", type: "number", placeholderKey: "activities.earthquakeResistantStructure.inputs.useVibrationTest" },
  ...
  "stretch-speed-and-gracefulness": [
    {
      id: "action-1",
      labelKey: "activities.stretchSpeedAndGracefulness.action1.label",
    ...
    {
      id: "action-2",
      labelKey: "activities.stretchSpeedAndGracefulness.action2.label",
    ...
    {
      id: "action-3",
      labelKey: "activities.stretchSpeedAndGracefulness.action3.label",
  ...
  "reaction-board-challenge": [
    {
      id: "action-1",
      labelKey: "activities.reactionBoardChallenge.action1.label",
    ...
    {
      id: "action-2",
      labelKey: "activities.reactionBoardChallenge.action2.label",
  ...
  "breathing-pace-trainer": [
    {
      id: "action-1",
       labelKey: "activities.breathingPaceTrainer.action1.label",
      subtitleKey: "activities.breathingPaceTrainer.action1.subtitle",
      inputs: [
        { id: "predictedBPM", labelKey: "activities.breathingPaceTrainer.inputs.predictedBPM", type: "number", placeholderKey: "activities.breathingPaceTrainer.inputs.zero" },
        { id: "measuredBPM", labelKey: "activities.breathingPaceTrainer.inputs.measuredBPM", type: "number", placeholderKey: "activities.breathingPaceTrainer.inputs.useBreathingTest" },
        { id: "observation", labelKey: "activities.breathingPaceTrainer.inputs.observation", type: "text", placeholderKey: "activities.breathingPaceTrainer.inputs.describeWhatHappened" },
      ],
    },
    {
      id: "action-2",
      labelKey: "activities.breathingPaceTrainer.action2.label",
      subtitleKey: "activities.breathingPaceTrainer.action2.subtitle",
      inputs: [
        { id: "predictedBPM", labelKey: "activities.breathingPaceTrainer.inputs.predictedBPM", type: "number", placeholderKey: "activities.breathingPaceTrainer.inputs.zero" },
        { id: "measuredBPM", labelKey: "activities.breathingPaceTrainer.inputs.measuredBPM", type: "number", placeholderKey: "activities.breathingPaceTrainer.inputs.useBreathingTest" },
        { id: "observation", labelKey: "activities.breathingPaceTrainer.inputs.observation", type: "text", placeholderKey: "activities.breathingPaceTrainer.inputs.describeWhatHappened" },
    ...
    {
      id: "action-3",
      labelKey: "activities.breathingPaceTrainer.action3.label",
      subtitleKey: "activities.breathingPaceTrainer.action3.subtitle",
      inputs: [
        { id: "predictedBPM", labelKey: "activities.breathingPaceTrainer.inputs.predictedBPM", type: "number", placeholderKey: "activities.breathingPaceTrainer.inputs.zero" },
        { id: "measuredBPM", labelKey: "activities.breathingPaceTrainer.inputs.measuredBPM", type: "number", placeholderKey: "activities.breathingPaceTrainer.inputs.useBreathingTest" },
        { id: "observation", labelKey: "activities.breathingPaceTrainer.inputs.observation", type: "text", placeholderKey: "activities.breathingPaceTrainer.inputs.describeWhatHappened" },
